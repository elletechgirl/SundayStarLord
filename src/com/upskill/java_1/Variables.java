...
// Variables in Java
	...
	//Static variable - variables belong to class and dont required creating object
	//Local variable - variables declared in methods
	//Method parameter - variables used as method parameter
	
	static String country = "USA";
	
	 static String region = "America";	//Static variable - variables belong to class and dont required creating object
